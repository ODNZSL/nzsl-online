...
class SignMenu
  HANDSHAPES = [
    [['1.1.1', '1.1.2', '1.1.3'].freeze, ['1.2.1', '1.2.2'].freeze, ['1.3.1', '1.3.2'].freeze, ['1.4.1'].freeze].freeze,
    [
      ['2.1.1', '2.1.2'].freeze,
      ['2.2.1', '2.2.2'].freeze,
    ...
    [['3.1.1'].freeze, ['3.2.1'].freeze, ['3.3.1'].freeze, ['3.4.1', '3.4.2'].freeze, ['3.5.1', '3.5.2'].freeze].freeze,
    [['4.1.1', '4.1.2'].freeze, ['4.2.1', '4.2.2'].freeze, ['4.3.1', '4.3.2'].freeze].freeze,
    [['5.1.1', '5.1.2'].freeze, ['5.2.1'].freeze, ['5.3.1', '5.3.2'].freeze, ['5.4.1'].freeze].freeze,
    [
