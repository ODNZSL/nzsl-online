...
class Sign
  ...
  class << self
    ...
    def find(params, all_or_first = :first)
    ...
    def current_page(per_page, last_result_index, all_result_length)
    ...
    def save_time_elapsed(url, before_time, count)
